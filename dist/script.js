...
var modals = function modals() {
  function showModal(triggerSelector, modalSelector, closeSelector) {
    var canClose = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === modal && canClose) {
        ...
        modal.style = 'dipslay:none';
        document.body.style.overflow = 'visible'; // document.body.classList.remove('modal-open');
      }
    });
  }
  ...
  showModal('.phone_link', '.popup_engineer', ' .popup_close', false); // showTimeModal('.popup', '.popup_close', 6000);
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var hideTabContant = function hideTabContant() {
  ...
  var showTabContant = function showTabContant() {
